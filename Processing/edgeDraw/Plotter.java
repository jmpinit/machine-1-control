...
class Plotter implements Runnable {
  ...
  protected Vector<Waypoint> path;
  ...
  public Plotter(Tool tool, float mmPerXStep, float mmPerYStep, float mmPerZStep, float widthInMM, float heightInMM) {
    ...
    path.add(new Waypoint(0, 0, 0, spraying));
  }
  ...
  public PVector getPosition() {
    return path.lastElement().position.copy();
  }
  ...
  class Waypoint {
    ...
    public final boolean spraying;

    public Waypoint(float x, float y, float z, boolean spraying) {
